...
{
    public class WorkerMedicalVerificationRepository : IWorkerMedicalVerificationRepository
    {
        private readonly IConfiguration _configuration;
        public WorkerMedicalVerificationRepository(IConfiguration configuration)
        {
